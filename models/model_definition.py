...
def graph_model(node_feature_dim: int, edge_feature_dim: int, global_feature_dim: int) -> keras.Model:
    inputs = get_graph_net_keras_inputs(node_feature_dim, edge_feature_dim, global_feature_dim)
